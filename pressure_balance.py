...
# 설계 입력값을 μ_s=0.45, μ_k=0.40으로 채택했고, 임계값을 106.4N으로 재산정했다.
# 이 마찰계수는 제조사 공식값이나 젖은 조립상태 실측값이 아니며, 임계값도
# 실제 가이드 재질/법선반력/모터 전달효율/판 질량 확인 전 계산 추정치다.
#
...
#    PRESSURE_THRESHOLD_N=106.4N은 종전 구동력 가정을 유지해 재산정한 잠정값이다.
...
# 종전 최대 선형 구동력 50.4N, 판 무게 추정 2.55N을 유지하면
# (50.4 - 2.55) / 0.45 ≈ 106.4N. 이는 F_net이 가이드 법선반력에
...
PRESSURE_THRESHOLD_N = 106.4   # 계산 추정치: 실제 구조 및 실험 검증 필요
